  ...
  return (
    <Card className="p-4 sm:p-6 bg-gradient-to-br from-card to-card/50">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-center">
        {/* Home Team */}
        <div className="order-1 md:order-none flex flex-col items-center text-center space-y-3 sm:space-y-4">
        ...
        {/* VS & H2H */}
        <div className="order-2 md:order-none flex flex-col items-center space-y-3 sm:space-y-4 md:col-start-2">
        ...
        {/* Away Team */}
        <div className="order-3 md:order-none flex flex-col items-center text-center space-y-3 sm:space-y-4">
